```bash
/ralph-loop "
Feature: 001-cloud-storage-import
Branch: git checkout 001-cloud-storage-import

PHASE 1 - COMPLETION CHECK:
- Read .prompts/001-cloud-storage-import/tasks.md
...
- Check .prompts/001-cloud-storage-import/spec.md requirements
- Document any gaps
